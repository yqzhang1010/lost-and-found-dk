...
const translations = {
  en: {
    ...
    heroTitle: "Lost and found in Denmark",
    heroText: "Post or find lost items in Denmark by city, category, date and location. Browse lost and found posts from Copenhagen, Aarhus, Aalborg and more.",
    ...
    aboutText: "LostFoundDK is a free community platform helping people reconnect with lost and found items across Denmark. Our mission is to make it easier for residents, students, and visitors to report and recover lost belongings.",
  ...
  da: {
    ...
    heroTitle: "Mistet og fundet i Danmark",
    heroText: "Opret eller find mistede genstande i Danmark efter by, kategori, dato og sted. Se opslag fra København, Aarhus, Aalborg og flere byer.",
    cityBoards: "Byopslag",
    ...
    aboutText: "LostFoundDK er en gratis platform for efterlysninger og fundne genstande i Danmark. Vores mål er at gøre det nemmere for borgere, studerende og besøgende at finde tilbage til deres mistede ejendele ved at forbinde mennesker gennem et lokalt fællesskab.",
      ...
      <section className="bg-white border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-4 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div className="flex w-full sm:w-auto items-center gap-3">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-bold tracking-tight">LostFoundDK</h1>
