      ...
      <div className="md:col-span-2 rounded-2xl border border-dashed border-slate-300 bg-slate-50 p-5 text-center">
        ...
        {previewImages.length > 0 && (
          <div className="mt-4 grid grid-cols-2 sm:grid-cols-3 gap-3">
            {previewImages.map((imageSrc, index) => <img key={index} src={imageSrc} alt={`Preview ${index + 1}`} className="w-full h-28 object-cover rounded-2xl border border-slate-200" />)}
          </div>
        )}
